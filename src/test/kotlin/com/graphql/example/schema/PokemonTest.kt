...
class PokemonTest: DescribeSpec({
    ...
    describe("Testing Pokemon class companion object methods not getters/setters"){
        ...
        val pikachuTest = Pokemon("Pikachu", 25, listOf(PokemonType.ELECTRIC), 0.0f, 0.0f, listOf(0), listOf(PokemonType.ELECTRIC), "Volt Tackle", "imageSource", listOf(1), "Mouse")
        val bulbasaurTest = Pokemon("Bulbasaur", 1, listOf(PokemonType.GRASS, PokemonType.POISON), 0.0f, 0.0f, listOf(0), listOf(PokemonType.GRASS), "Vine Whip", "imageSource", listOf(1), "Seed")
        val charmanderTest = Pokemon("Charmander", 4, listOf(PokemonType.FIRE), 0.0f, 0.0f, listOf(0), listOf(PokemonType.FIRE), "Ember", "imageSource", listOf(1), "Lizard")
        val squirtleTest = Pokemon("Squirtle", 7, listOf(PokemonType.WATER), 0.0f, 0.0f, listOf(0), listOf(PokemonType.WATER), "Water Gun", "imageSource", listOf(1), "Tiny Turtle")
        ...
        describe("search method"){
            ...
            it("returns expected pokemon for valid pokemon ids"){
